...
import { Currency, CurrencyAmount, Pair, Token, Trade } from '@soy-libs/sdk2';
...
import { isTradeBetter } from '~/app/utils/trades';
    ...
    () =>
      Object.values(
        allPairs
          ...
          .reduce<{ [pairAddress: string]: Pair }>((memo: any, [, curr]: any) => {
