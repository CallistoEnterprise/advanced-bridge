...
import { DEFAULT_LIST_OF_LISTS, UNSUPPORTED_LIST_URLS } from '~/app/constants/lists';
import DEFAULT_TOKEN_LIST from '~/app/constants/tokenLists/tokenlist.json';
import UNSUPPORTED_TOKEN_LIST from '~/app/constants/tokenLists/unsupported.tokenlist.json';
